...
<ol align="right" style="direction: rtl">
  <li align="right">
    ...
    <ul align="right" style="direction: rtl">
      ...
      <li align="right">
        این کد ها به صورت یک <a href="discount_codes.json" download>فایل جیسون</a> در اختیار شما قرار داده شده است.
      </li>
      <li align="right">
...
<img src="https://i.imgur.com/dBaSKWF.gif" height="20" width="100%" />
<h3 align="right"  style = "direction: rtl"> دستورات ورودی در CLI </h3>
<p align="right" style = "direction : rtl">
  برای استفاده از دستورات ورود به سیستم می توانید از شرط ها برای parse کردن
  استفاده کنید یا می توانید برای سادگی و راحتی کار از کتابخانه argparser
  استفاده کنید.اما به این نکته توجه داشته باشید که عدم استفاده از کتابخانه باعث
...
<p align="right"  style="direction: rtl">
  ...
  کتابخانه tabulate استفاده کنید.
</p>
